...
# we could basically train a model for each season. Test it against other seasons? How do we want to do this? We're probably looking to determine win probabilities right?
